...
//             if(element[i]<target && target<element[i+1])
//                 return i+1;
//         }
//     }
//     return element.length;
// }
// console.log(searchInsertPosition([1,3,5,6],5)); //1
// console.log(searchInsertPosition([1,3,5,6],2)); //3
// console.log(searchInsertPosition([1,3,5,6],7)); //2
function searchInsertPosition(element, target) {
    var left = 0;
    var right = element.length - 1;
    while (left <= right) {
